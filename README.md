...
# Melhorias
"Implementei funcionalidades RESTful usando Java e Spring Boot, incluindo criação de endpoints
 dinâmicos e integração com HTML para respostas personalizadas. Explorei estilização via tags 
HTML e lógica condicional."